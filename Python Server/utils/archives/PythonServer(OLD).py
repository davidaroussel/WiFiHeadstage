...
<<<<<<< HEAD:WiFiHeadstage V1/Python/PythonServer.py
        self.clients = []
=======
>>>>>>> 84418e0d4bc2f894c7f7ec520b18aa74e4cf84ab:Python Server/utils/archives/PythonServer(OLD).py
        self.m_port = p_port
        self.m_socket = 0
