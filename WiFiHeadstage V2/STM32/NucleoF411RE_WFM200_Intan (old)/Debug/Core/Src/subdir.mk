...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/dhcp_client.d ./Core/Src/dhcp_client.o ./Core/Src/dhcp_client.su ./Core/Src/dhcp_server.d ./Core/Src/dhcp_server.o ./Core/Src/dhcp_server.su ./Core/Src/ethernetif.d ./Core/Src/ethernetif.o ./Core/Src/ethernetif.su ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/lwip_freertos.d ./Core/Src/lwip_freertos.o ./Core/Src/lwip_freertos.su ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/wifi_cli.d ./Core/Src/wifi_cli.o ./Core/Src/wifi_cli.su
