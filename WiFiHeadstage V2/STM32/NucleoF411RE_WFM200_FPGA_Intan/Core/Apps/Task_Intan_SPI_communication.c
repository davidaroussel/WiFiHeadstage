...
//    while (1) {
//        if (samplingEnabled) {
//            print("Sampling at 5KHz \r\n");
//        }
//        osDelay(SAMPLE_PERIOD_MS);  // Wait for next cycle
//    }
//}
//
//void StartSamplingTask(void) {
//	printf("Starting RHD Task \r\n");
//    osThreadDef(SampleTask, SamplingTask, osPriorityNormal, 0, configMINIMAL_STACK_SIZE*10);
//    sampleTaskHandle = osThreadCreate(osThread(SampleTask), NULL);
//}
//
//void EnableSampling(void) {
