...
if __name__ == '__main__':
    ...
    for experiment_directory in experiment_directories:
        ...
        #
        # clusters = plot_clustered_spikes(data, num_channels, lowcut=180.0, highcut=3000.0,
        #                       fs=continuous.metadata['sample_rate'], directory_name=directory_name,
        #                       save_directory=save_directory, save_figure=True)
        #
        # plot_raw_spikes(data, clusters, num_channels, lowcut=180.0, highcut=3000.0,
        #                 fs=continuous.metadata['sample_rate'], directory_name=directory_name,
        #                 save_directory=save_directory, save_figure=True)

        # clusters = plot_global_spike_clusters(data, num_channels, lowcut=180.0, highcut=3000.0,
        #                       fs=continuous.metadata['sample_rate'], directory_name=directory_name,
        #                       save_directory=save_directory, save_figure=True)


        # plot_raw_and_clustered_spikes(data, num_channels, lowcut=180.0, highcut=3000.0,
        #                 fs=continuous.metadata['sample_rate'], directory_name=directory_name,
        #                 save_directory=save_directory, save_figure=True)
